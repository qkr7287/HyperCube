# LVM Thin Workspace Host Setup Runbook (SUPERSEDED 2026-05-16)

> **Superseded by `docs/runbooks/workspace-quota-full-validation.md`.**
> HyperCube moved per-container `/workspace` enforcement from LVM thin
> volumes to XFS project quota on a loop-mounted xfs file (option 4b)
> on 2026-05-16. This file is preserved for history only — do not run
> these commands on new hosts.

This runbook was the operator gate for enabling HyperCube per-container
